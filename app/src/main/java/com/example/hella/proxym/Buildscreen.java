...
public class Buildscreen extends FragmentActivity implements OnMapReadyCallback ,
    ...
    private ImageButton mode_button_two;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.mip);
        mapFragment.getMapAsync(this);

        mode_button_two =(ImageButton) findViewById(R.id.mode_button_two);
        mode_button_two.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent _intent = new Intent(_context, Collectscreen.class);
