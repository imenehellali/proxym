                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            StorageReference reRef= mStorageRef.child("Profiles").child(""+mAuth.getUid()+".jpg");
                            ...
                            if(profile_pic_uri !=null) {
                                ...
                                profile_pic_string= "Profiles/"+mAuth.getUid();
                            Intent _intent = new Intent(_context, Avatarscreen.class).putExtra("passed_email",_Username).putExtra("passed_password",_password).putExtra("passed_profilePic",profile_pic_string);
                            finish();
